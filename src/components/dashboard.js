...
import { MainListItems, SecondaryListItems, MainListItemsEmployee, SecondaryListItemsEmployee} from './drawerItems';
            ...
            <Box sx={{ display: 'flex'}}>
                ...
                <AppBar position='absolute' open={open_drawer}>
                    ...
                    >
                        ...
                        {userProfile && userProfile === 'employer' && (<Tooltip title="Create New Task">

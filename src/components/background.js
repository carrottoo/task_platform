...
const FallingSquares = () => {
    ...
    useEffect(() => {
        ...
        const color_palette = [[208, 222, 226], [198, 198, 198], [171, 181, 172], [181, 169, 157],
            [195, 210, 244], [196, 186, 188], [255, 228, 163], [249, 232, 157],
                [255, 247, 188], [252, 236, 153], [234, 211, 224], [252, 219, 199], [116, 129, 155],
                [221, 85, 6], [193, 75, 11], [14, 150, 209], [90, 159, 244], [255, 255, 255]];
        var rotations = []  
        for (let i = 0; i < particles; i++) {
            ...
            const color = new THREE.Color(rgb_color[0]/255., rgb_color[1]/255., rgb_color[2]/255.);
            ...
            // Add new property
            mesh.rotation_delta = [0.12 * (Math.random() - 0.5), 0.12* (Math.random() - 0.5), 0.12 * (Math.random()-0.5)];

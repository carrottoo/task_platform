  ...
  const handleInputChange = (prop) => (event) => {
    setUser((prevUser) => {
      ...
      if (newValue !== prevUser[prop]) {
        ...
        console.log(
          `Field ${prop} changed from ${prevUser[prop]} to ${newValue}`,
        );
      }
    ...
    if (Object.keys(changedFields).length > 0) {
      try {
        ...
        if (result.error) {
          ...
          for (const frontendField in userMapping) {
            // Iterate through frontend fields
            const backendField = userMapping[frontendField];
        ...
        {user && (
          <>
            ...
            <TextField
              ...
              helperText={
                errors["lastLogin"]
                  ? errors["lastLogin"].message || errors["lastLogin"]
                  : ""
              }
              margin="normal"
              variant="standard"
            ...
            <TextField
              ...
              helperText={
                errors["dateJoined"]
                  ? errors["dateJoined"].message || errors["dateJoined"]
                  : ""
              }
              margin="normal"
              variant="standard"

...
function AddTask(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const errorMessage =
        error.message || "Failed to create the task, please try again.";
    ...
    <Dialog open={props.open} onClose={handleClose}>
      ...
      <DialogContent>
        <TextField
          ...
          helperText={
            errors["taskName"]
              ? errors["taskName"].message || errors["taskName"]
              : ""
          }
        ...
        <TextField
          ...
          helperText={
            errors["taskDescription"]
              ? errors["taskDescription"].message || errors["taskDescription"]
              : ""
          }
        ...
        <TextField
          ...
          helperText={
            errors["taskOutput"]
              ? errors["taskOutput"].message || errors["taskOutput"]
              : ""
          }

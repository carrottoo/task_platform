...
import {Typography, Pagination, IconButton, Tooltip, 
        Grid,
        CardContent,
        CardActions,
        Card,
...
export function CardDisplay( {tags, onDeleteTag, onLikeTag, onDislikeTag, isEditing}) {
                ...
                <Grid container spacing={2}> 
                    {currentTags.map((tag) => (
                        <Grid item key={tag.id} xs="auto">
                            <Card sx={{ display: 'flex', width: 'auto', maxWidth: 400, padding: 1 }}>

    ...
    const fetchTasks = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const unassignedCount = data.results.filter(
            (task) => task.assignee === null,
          ).length;
          setUnassignedCount(unassignedCount);

          const assignedCount = data.results.filter(
            (task) => task.assignee !== null,
          ).length;
          setAssignedCount(assignedCount);

          const reviewCount = data.results.filter(
            (task) => task.is_submitted === true,
          ).length;
          ...
          <Card sx={{ maxWidth: 345 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Number of all tasks that have been created by you. You are the
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Card sx={{ maxWidth: 345 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Tasks created by you that have been assigned to our users and
                are in progress.
              </Typography>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Card sx={{ maxWidth: 345 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Tasks created by you that have not been neither assigned to nor
                started by our users successfully.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <Card sx={{ maxWidth: 345 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Tasks that are completed and submitted by our users. You can
                start review them!
              </Typography>
            </CardContent>
          </Card>

  ...
  return (
    <Timeline position="right">
        ...
        <TimelineContent>
          <Stack direction="column" spacing={2}>
            ...
            >
              <CardContent>
                <Typography variant="body2" color="text.secondary">
                  Sign up as a new user and choose your profile (employer to
                  publish tasks or employee to take and complete tasks)
                </Typography>
              </CardContent>
            </Card>
          </Stack>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Stack direction="column" spacing={2}>
            <Typography>Publish Your Task</Typography>
            <Card
              sx={{
                width: 400,
                backgroundColor: "rgba(255, 165, 0, 0.5)",
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Stack direction="column" spacing={2}>
            <Typography>Task Taken by User</Typography>
            <Card
              sx={{
                width: 400,
                backgroundColor: "rgba(255, 165, 0, 0.5)",
            ...
            >
              <CardContent>
                <Typography variant="body2" color="text.secondary">
                  Interested users take the tasks from our active task pool and
        ...
        <TimelineContent>
          <Stack direction="column" spacing={2}>
            ...
            >
              <CardContent>
                <Typography variant="body2" color="text.secondary">
                  System changes the status to 'assigned', assignee can start
        ...
        <TimelineContent>
          <Stack direction="column" spacing={2}>
            ...
            >
              <CardContent>
                <Typography variant="body2" color="text.secondary">
                  After task is submitted by the assignee, task publisher can
                  review and approve. Once approved, the task will be marked as
                  'completed'. Bingo !
                </Typography>
              </CardContent>
            </Card>
